...
// Tampilkan pesan informatif jika diredirect karena sesi tidak valid
if (($_GET['reason'] ?? '') === 'session_invalid') {
    $warning = 'Sesi Anda sudah tidak valid (mungkin karena database di-reset). Silakan login ulang.';
}
...
<head>
  ...
  <title>Login Admin - Sistem Manajemen Audit</title>
...
<div class="page">
  ...
  <main class="card" role="main">
    ...
    <p class="card-subtitle">Gunakan akun kredensial resmi Administrator</p>
    ...
    <form method="POST" action="">
      ...
      <div class="field">
        <div class="field-header">
          ...
          <a href="<?= BASE_URL ?>/admin/lupa-sandi.php" class="forgot">Lupa sandi?</a>
        </div>
        <div class="input-wrap">
          <svg class="input-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8">
